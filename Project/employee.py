...
class login_page:
    def __init__(self, top=None):
        ...
        self.button1.configure(activebackground="#1a11f9")
        self.button1.configure(cursor="hand2")
        self.button1.configure(foreground="#ffffff")
        self.button1.configure(background="#1a11f9")
...
class bill_window:
    def __init__(self, top=None):
        ...
        self.button2.configure(activebackground="#1a11f9")
        self.button2.configure(cursor="hand2")
        self.button2.configure(foreground="#ffffff")
        self.button2.configure(background="#1a11f9")
        ...
        self.button3.configure(activebackground="#1a11f9")
        self.button3.configure(cursor="hand2")
        self.button3.configure(foreground="#ffffff")
        self.button3.configure(background="#1a11f9")
        ...
        self.button4.configure(activebackground="#1a11f9")
        self.button4.configure(cursor="hand2")
        self.button4.configure(foreground="#ffffff")
        self.button4.configure(background="#1a11f9")
        ...
        self.button5.configure(activebackground="#1a11f9")
        self.button5.configure(cursor="hand2")
        self.button5.configure(foreground="#ffffff")
        self.button5.configure(background="#1a11f9")
        ...
        self.button6.configure(activebackground="#1a11f9")
        self.button6.configure(cursor="hand2")
        self.button6.configure(foreground="#ffffff")
        self.button6.configure(background="#1a11f9")
        ...
        self.button7.configure(activebackground="#1a11f9")
        self.button7.configure(cursor="hand2")
        self.button7.configure(foreground="#ffffff")
        self.button7.configure(background="#1a11f9")
        ...
        self.button8.configure(activebackground="#1a11f9")
        self.button8.configure(cursor="hand2")
        self.button8.configure(foreground="#ffffff")
        self.button8.configure(background="#1a11f9")
        ...
        self.button9.configure(activebackground="#1a11f9")
        self.button9.configure(cursor="hand2")
        self.button9.configure(foreground="#ffffff")
        self.button9.configure(background="#1a11f9")
    ...
    def search_bill(self):
        ...
        if results:
            ...
            self.entry1.configure(state="disabled", disabledbackground="#1a11f9", disabledforeground="#000000")
            self.entry2.configure(state="disabled", disabledbackground="#1a11f9", disabledforeground="#000000")
